...
export default function CommandMenu({
  ...
  if (commands.length === 0) {
    return (
      <div
        ref={menuRef}
        className="command-menu command-menu-empty border border-border bg-background text-muted-foreground dark:border-border dark:bg-muted dark:text-muted-foreground"
  ...
  return (
    <div
      ...
      className="command-menu border border-border bg-background dark:border-border dark:bg-muted"
            ...
            return (
              ...
              >
                <div className="min-w-0 flex-1">
                  ...
                  {command.description && (
                    <div className="ml-6 truncate whitespace-nowrap text-[13px] text-muted-foreground dark:text-muted-foreground">
                      {command.description}
                    </div>
                  )}
                </div>
