  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <div className="w-full max-w-md">
        <div className="auth-card space-y-6 rounded-lg border border-border bg-card p-8 shadow-lg">
          <div className="auth-brand text-center">
            ...
            <h1 className="auth-h1 text-2xl font-bold text-foreground">{title}</h1>
            <p className="auth-sub mt-2 text-muted-foreground">{description}</p>
          </div>

          {children}

          <div className="auth-foot text-center">
          ...
          {!IS_PLATFORM && (
            <div className="flex items-center justify-center gap-1.5 pt-2">
              ...
              <a
                href="https://github.com/kolisachint/hoocowork"
                target="_blank"
                rel="noopener noreferrer"
                className="text-xs text-muted-foreground/50 transition-colors hover:text-muted-foreground"
              >
                HooCowork is open source
              </a>
            </div>
          )}
        </div>
