...
> ## This package has moved to [`@kolisachint/hoocowork`](https://www.npmjs.com/package/@kolisachint/hoocowork)
>
> ```bash
> npm install -g @kolisachint/hoocowork
> # or with bun:
> bun install -g @kolisachint/hoocowork
> ```
>
> This package (`@siteboon/claude-code-ui`) is now a thin wrapper that installs the new package automatically.
> For new installations, use `@kolisachint/hoocowork` directly.
...
<div align="center">
  <img src="https://raw.githubusercontent.com/kolisachint/hoocowork/main/public/logo.svg" alt="HooCowork" width="64" height="64">
...
<p align="center">
  <a href="https://hoocowork.app"><img src="https://img.shields.io/badge/☁️_HooCowork_Cloud-Try_Now-0066FF?style=for-the-badge" alt="HooCowork"></a>
...
<td align="center">
<h3>Desktop View</h3>
<img src="https://raw.githubusercontent.com/kolisachint/hoocowork/main/public/screenshots/desktop-main.png" alt="Desktop Interface" width="400">
<br>
<em>Main interface showing project overview and chat</em>
</td>
<td align="center">
<h3>Mobile Experience</h3>
<img src="https://raw.githubusercontent.com/kolisachint/hoocowork/main/public/screenshots/mobile-chat.png" alt="Mobile Interface" width="250">
<br>
...
<h3>CLI Selection</h3>
<img src="https://raw.githubusercontent.com/kolisachint/hoocowork/main/public/screenshots/cli-selection.png" alt="CLI Selection" width="400">
<br>
...
- **Model Compatibility** - Works with Claude, GPT, and Gemini model families (see [`shared/modelConstants.js`](https://github.com/kolisachint/hoocowork/blob/main/shared/modelConstants.js) for the full list of supported models)
...
Try HooCowork instantly with **npx** (requires **Node.js** v22+):
...
Visit the **[documentation →](https://hoocowork.app/docs)** for more full configuration options, PM2, remote server setup and more
...
HooCowork is the open source UI layer that powers HooCowork. You can self-host it on your own machine, or use HooCowork which builds on top of it with a full managed cloud environment, team features, and deeper integrations.

| | HooCowork (Self-hosted) | HooCowork |
|---|---|---|
...
| **Setup** | `npx @kolisachint/hoocowork` | No setup required |
...
> Both options use your own AI subscriptions (Claude, Cursor, etc.) — HooCowork provides the environment, not the AI.
...
HooCowork and HooCowork extend Claude Code rather than sit alongside it — your MCP servers, permissions, settings, and sessions are the exact same ones Claude Code uses natively. Nothing is duplicated or managed separately.
...
- **HooCowork runs in the cloud** — close your laptop, the agent keeps running. No terminal to babysit, no machine to keep awake.
...
Yes. HooCowork provides the environment, not the AI. You bring your own Claude, Cursor, Codex, or Gemini subscription. HooCowork starts at $7/month for the hosted environment on top of that.
...
Yes. For self-hosted, run the server on your machine and open `[yourip]:port` in any browser on your network. For HooCowork, open it from any device — no VPN, no port forwarding, no setup. A native app is also in the works.
...
Yes, for self-hosted. HooCowork reads from and writes to the same `~/.claude` config that Claude Code uses natively. MCP servers you add via the UI show up in Claude Code immediately and vice versa.
...
- **[Contributing Guide](https://github.com/kolisachint/hoocowork/blob/main/CONTRIBUTING.md)** — how to contribute to the project

## License

GNU Affero General Public License v3.0 or later (AGPL-3.0-or-later) — see [LICENSE](https://github.com/kolisachint/hoocowork/blob/main/LICENSE) for the full text, including additional terms under Section 7.
